...
function render(vnode, container) {
  console.log(vnode); // 如果vode是undefined，就什么都不做

  if (vnode === undefined) return; // 如果是字符串则直接渲染到container
...
_reactDom.default.render(ele, document.querySelector('#root')); // createElement(tag,attr,child1,child2....)
